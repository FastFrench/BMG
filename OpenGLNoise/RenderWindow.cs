...
namespace OpenGLNoise
{
	public class RenderWindow : GameWindow
	{
		...
		string GetRandomFragmentShader()
		{
			return "Explosion_Frag";
		...
		string GetRandomVertexShader()
		{
			return "Explosion_Vert";
		...
		{
			var sphere = new SphereObject(new Vector3(px, py, pz), radius, rnd.Next(2) == 0);
