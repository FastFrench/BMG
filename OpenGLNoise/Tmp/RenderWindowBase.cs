...
namespace OpenGLNoise
{
	public abstract class RenderWindowBase : GameWindow
	{
		...
		void UpdateAndFillGlobalSettingsUniformBuffer(FrameEventArgs e)
		{
			...
			GlobalSettingsStruct.NbLights = LightsUBOData.Length;
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			GlobalSettingsStruct.View = Matrix4.LookAt(new Vector3(7, 0, 0), Vector3.Zero, Vector3.UnitZ);
		...
		protected override void OnUpdateFrame(FrameEventArgs e)
		{
			...
			GlobalSettingsStruct.View = Matrix4.LookAt(new Vector3(0, alt, 0), new Vector3(0, 0, 0), Vector3.UnitZ);
